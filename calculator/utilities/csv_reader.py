...
class CsvReader:  # pylint: disable=too-few-public-methods,pointless-string-statement,consider-using-enumerate,
    # line-too-long
    """Class for reading csv file"""

    @staticmethod
    def read_csv(path: str):
        """Read the csv file and return its dataframe"""
    ...
    def read_csv_dict(data_frame: pd.DataFrame):
        """Take in a dataframe and return it as a dictionary"""
